...
const AboutUs2 = () => {
    return (
        <div>
            <header>
                <h1 class="text-center">Welcome to Parsoya</h1>
                <h1 class="text-center mb-3" style={{marginBottom:'2rem !important'}}>Constructions</h1>
                <p class="text-center">Building dreams with precision and dedication. Learn more</p>
                <p class="text-center">about our journey, values, and team.</p>
            </header>
            <section>
            <div class="container">
           <div class="row">
             ...
             <div class="col-sm-12 col-md-6 col-lg-4 my-3">
               <div class="card border-0">
                  <div class="card-body text-center">
                    <span>
                        <svg style={{ width: 50, height: 50}} class="yellow-icon" enable-background="new 0 0 48 48" version="1.1" >
                            <g class="layer">
                            <title>Layer 1</title>
                            <g id="svg_1">
                            <g id="svg_2">
                    ...
                    <h4 class="text-uppercase mt-3">Our Team</h4>
                    <p>Our team of experienced professionals is dedicated to ensuring the success of every project we undertake.</p>
                  </div>
                </div>
             </div>
           </div>
